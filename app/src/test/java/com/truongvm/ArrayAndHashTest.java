...
class ArrayAndHashTest {
    ...
    void containDuplicateTest() {
        ...
        assertEquals(solution.containsDuplicate(new int[] { 1, 5, 6, 2, 3, 4, 2, 3, 1, 2,
                4 }), true, "Test 2 failed");
        assertEquals(solution.containsDuplicate(new int[] { 1, 2, 4, 5, 7, 8, 111, 112
        }), false, "Test 3 failed");
        assertEquals(solution.containsDuplicate(new int[] { 11, 2, 4, 5, 7, 8, 111, 112,
    ...
    @Test
    void twoSumTest() {
        assertArrayEquals(solution.twoSum(new int[] { 2, 7, 11, 15 }, 9), new int[] { 0, 1 }, "Test 1 failed");
    ...
    void groupAnagramsTest() {
        assertEquals(solution.groupAnagrams(new String[] { "eat", "tea", "tan", "ate", "nat", "bat" }).size(), 3,
                "Test 1 failed");
        ...
        assertEquals(solution.groupAnagrams(
                new String[] { "ass", "ssa", "sas", "", "testt", "tetts", "tttes", "ttest", "etstt", "hura", "haru" })
                .size(), 4, "Test 4 failed");
    }
}
